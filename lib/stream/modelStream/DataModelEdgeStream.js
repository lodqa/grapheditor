...
export default class extends ActionTransform {
  constructor(edges) {
    ...
    this.bindActions(target.MODEL_EDGE, [
      ...
      [actionType.UPDATE_TEXT, (action, push) => updateEdgeText(edges, action, push)],
      [actionType.UPDATE_TERM, (action, push) => updateEdgeTerm(edges, action, push)]
    ])
  }
}
...
function updateEdgeText(model, action, push) {
...
function updateEdgeTerm(model, action, push) {
