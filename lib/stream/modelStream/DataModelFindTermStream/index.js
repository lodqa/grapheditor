  ...
  constructor(nodes, edges, findTermUrl) {
    ...
    this.bindActions(target.MODEL, [
      ...
      [actionType.FIND_TERM, (action, push) => done(push, [
        ...
        toInformation(edges, edges.texts, target.VIEW_EDGE, findTermUrl, predDictionaryUrl)
      ])]
    ])
    ...
    this.bindActions(target.MODEL_EDGE, [
      [actionType.FIND_TERM, (action, push) => done(push, [
        toInformation(edges, [edges.getText(action.id)], target.VIEW_EDGE, findTermUrl, predDictionaryUrl)
      ])]
    ])
  }
}
