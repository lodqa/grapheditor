...
export default class extends ActionTransform {
  constructor() {
    ...
    this.bindActions(target.VIEW_EDGE, [
      [actionType.AFTER_CREATE, (action, push) => component.addEdge(action.sourceId, action.targetId)],
      [actionType.DELETE, (action, push) => component.delEdge(action.sourceId, action.targetId)]
    ])
  }
}
