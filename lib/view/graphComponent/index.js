...
export default function(selector) {
  ...
  return {
    ...
    container: container,
    emitter: emitter,
    createNode: (id, name, url) => nodeApi.create(container, instance, id, name, callbacks),
    updateNode: (id, name, url) => nodeApi.update(container, id, name),
    ...
    createEdge: (edge, label, url) => edgeApi.create(
      instance,
      edge.sourceId,
      edge.targetId,
    ...
    detachEdge: (edge) => edgeApi.detach(instance, edge.sourceId, edge.targetId),
