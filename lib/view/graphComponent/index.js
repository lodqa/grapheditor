...
export default function(selector) {
  let container = document.querySelector(selector),
    callbacks = dragCallbacks(emitter, container)
  ...
  return {
    ...
    container: container,
    emitter: emitter,
    createNode: (id, name, url) => createNode(container, instance, id, name, url, callbacks),
    updateNode: (id, name, url) => updateNode(container, id, name, url),
    deleteNode: (id) => deleteNode(container, id),
    moveNode: (id, x, y) => moveNode(container, instance, id, x, y),
    selectNode: (id) => selectNode(container, id),
    unselectNode: () => unselectNode(container),
    hoverNode: (sourceId, targetId) => hoverNode(instance, sourceId, targetId),
    unhoverNode: () => unhoverNode(container),
    ...
    deleteEdge: (sourceId, targetId) => deleteEdge(instance, sourceId, targetId),
...
function hoverNode(instance, sourceId, targetId) {
  let connections = instance.getConnections({source: sourceId, target: targetId})
