...
export default function(selector) {
  ...
  return {
    ...
    createEdge: (sourceId, targetId, label, url) => edge.create(
      instance,
      sourceId,
      targetId,
    ...
    detachEdge: (sourceId, targetId) => edge.detach(instance, sourceId, targetId),
    deleteEdge: (sourceId, targetId) => edge.remove(instance, sourceId, targetId),
    selectEdge: (sourceId, targetId) => edge.select(container, instance, sourceId, targetId),
